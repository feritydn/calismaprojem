...
public class StringMethods04 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.contains("m")); // tek harf bile olsa String yapmaliyiz. // false
		...
		String str2 = " Ali Can      ";
		System.out.println("trim kullanmadan once:" + str2); // " Ali Can    "
		System.out.println("trim kullanmadan once:" + str2.trim()); // Ali Can
